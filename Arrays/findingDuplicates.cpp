...
// Time complexity: O(n)
int findDuplicatesM1(int A[], int length){
    int lastDuplicate = 0;
...
// Function to dind duplicates in an array and also to count number of duplicates
// Time complexity: O(n)
int findDuplicatesM2(int A[], int length) {
    int i, j;
...
// Time complexity: O(n)
int findDuplicatesM3(int A[], int length) {
